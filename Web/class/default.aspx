<%@ Page Title="查看班级列表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Topicsys.Web.v_class.List" %>
    ...
    <div class="card-body">
        ...
        <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3" OnPageIndexChanging="gridView_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="class_name" HeaderText="名称" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="class_note" HeaderText="备注" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="class_stat" HeaderText="状态" ItemStyle-HorizontalAlign="Center" />
