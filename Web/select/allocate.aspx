<%@ Page Title="分配题目给学生-查看可选题目列表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="allocate.aspx.cs" Inherits="Topicsys.Web.select.allocate" %>
    ...
    <div class="card-body">
        ...
        <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3" OnPageIndexChanging="gridView_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:ButtonField ButtonType="Button" HeaderText="操作" Text="分配该题目" CommandName="ApplyFor" />
            </Columns>
