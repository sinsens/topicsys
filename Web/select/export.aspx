<%@ Page Title="导出学生选题结果" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="export.aspx.cs" Inherits="Topicsys.Web.select.export" %>
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <asp:DropDownList ID="ddlType" runat="server" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                <asp:ListItem Value="dept">按系别</asp:ListItem>
                <asp:ListItem Value="major">按专业</asp:ListItem>
                <asp:ListItem Value="class">按班级</asp:ListItem>
                <asp:ListItem Value="teacher">按导师</asp:ListItem>
